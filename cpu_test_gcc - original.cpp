...
#define RETURN_OPVEC(x) { OPVEC opvec; opvec.pfn = (x); opvec.pduop = &pduop[1]; return (__int64)opvec; }
#define RETURN_OPVEC_2(x,y) { OPVEC opvec; opvec.pfn = (x); opvec.pduop = (y); return (__int64)opvec; }
